...
class PizzaFragment : Fragment() {
  ...
  private fun setupListeners() {
    binding?.pizzaRecyclerview?.adapter =
        PizzaListAdapter(
            minusClickListener =
                MinusButtonListener { pizzaName -> sharedViewModel.decreasePizza(pizzaName) },
            plusClickListener =
                PlusButtonListener { pizzaName -> sharedViewModel.increasePizza(pizzaName) })
  }
  ...
  fun goToNextScreen() {
    if (sharedViewModel.areAllPizzasSelected())
